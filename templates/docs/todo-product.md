...
Pending work for the product itself. Completed items are recorded in `change-log-product.md` with a date stamp — **closing an item here is not a change-log entry.**
