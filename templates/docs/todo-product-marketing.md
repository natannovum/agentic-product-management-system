# Todo — product marketing

Pending work for published surfaces — marketing site, user documentation, store or marketplace listings. Completed items are recorded in `change-log-product-marketing.md` with a date stamp — **closing an item here is not a change-log entry.**
